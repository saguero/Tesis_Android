...
public class ACCMetric extends AbsEvaluationMetric{

	public ACCMetric() {
		super(AbsMetricsCollection.ACC,Required.MAX, Representation.NORMALIZED, Type.CLASSIFICATION, Info.ERROR_PREDICTION, "Accuracy");

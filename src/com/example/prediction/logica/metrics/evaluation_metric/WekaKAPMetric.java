...
public class WekaKAPMetric extends AbsWekaEvaluationMetric {

	public WekaKAPMetric() {
		super(MetricsCollection.KAP, Required.MAX, Representation.NORMALIZED, Type.CLASSIFICATION,

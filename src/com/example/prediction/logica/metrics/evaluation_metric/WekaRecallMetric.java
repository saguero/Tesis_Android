...
public class WekaRecallMetric extends AbsWekaEvaluationMetric {

	public WekaRecallMetric() {
		super(MetricsCollection.RECALL,Required.MAX, Representation.NORMALIZED, Type.CLASSIFICATION, Info.ERROR_PREDICTION, "Recall");

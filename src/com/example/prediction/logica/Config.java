...
public class Config {
	...
	public class Exception {
		...
		public final static int EXCEPTION_MISSING_LIBRARY = R.string.configures_exception_missinglibrary;	
		public final static int EXCEPTION_MISSING_FILEDATASET = R.string.configures_exception_missingfiledataset;
		public final static int EXCEPTION_MISSING_PREDATT = R.string.configures_exception_missingpredatt;
		public final static int EXCEPTION_MISSING_SCHEME = R.string.exception_selectscheme;

		public final static int EXCEPTION_ALREADY_SAVED = R.string.exception_alreadysaved;
